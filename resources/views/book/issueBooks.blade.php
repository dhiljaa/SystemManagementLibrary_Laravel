...
@section('content')
    <div id="admin-content">
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    <h2 class="admin-heading">Semua Peminjaman Buku</h2>
                </div>
    ...
    @if ($book->issue_status == 'Y')
        <span class='badge badge-success' style="background-color: #28a745; color: white;">Sudah Dikembalikan</span>
    @else
        <span class='badge badge-danger' style="background-color: #dc3545; color: white;">Dipinjam</span>
    @endif
</td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="10">Belum Ada Buku yang Dipinjam</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
